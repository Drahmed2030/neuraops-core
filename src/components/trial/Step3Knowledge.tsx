...
export function Step3Knowledge({
  ...
  // Public trial users do not call the privileged channel-activation API.
  // The proof clock starts on the first real demo message via /api/chat.
  // Future verified WhatsApp/Instagram webhooks may activate channels server-side.
  ...
  return (
    <section className="animate-fade-slide">
      ...
      >
        ...
        <div className="text-[12.5px] text-ink-950/50 dark:text-paper-50/50">
          {t.uploadHint}
        </div>
        <input
          ref={fileInputRef}
      ...
      <div className="mb-5">
        <label className="block text-[13.5px] font-semibold mb-2">
          {t.fTopics}{' '}
          <span className="font-normal text-ink-950/40 dark:text-paper-50/40 text-[12.5px]">
            {t.optional}
          </span>
        </label>
